     ...
     <aside class="sidebar text-end">
        ...
        <nav>
            <ul>
                ...
                <li  class="active"><a href="gestion_clients.php"><i class="fas fa-users"></i> Utilisateurs</a></li>
                    ...
                    <tbody>
                        <?php if ($result && $result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td><?= $row['loginutilisateur'] ?></td>
                                <td><?= $row['telutilisateur'] ?></td>
                                <td><?= $row['villeutilisateur'] ?></td>
                                <td>
                                <a href="voir_client.php?cinutilisateur=<?= $row['cinutilisateur'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2m5 11h-4v4h-2v-4H7v-2h4V7h2v4h4z"/></svg></a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr>
                            <td colspan="7" class="text-center">Aucune utilisateur trouvée.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
