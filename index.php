<?php
    ...
    $sql = "SELECT * FROM voiture LIMIT 6";
...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/carousel-1.jpg" alt="Image" width="602px" height="700px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Rent A Car</h4>
                            <h1 class="display-1 text-white mb-md-4">Best Rental Cars In Your Location</h1>
                            <a href="connexionClient.php" class="btn py-md-3 px-md-5 mt-2" style="background-color: #75564d; color: #ffffff;">Reserve Now</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="img/carousel-2.jpg" alt="Image" width="602px" height="700px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Rent A Car</h4>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="img/cars3.png" alt="">
                    <p>In a fast-paced world, DriveNow gives you the freedom to move without the hassle. Whether you need a car for a quick trip around the city or a long road adventure, our platform offers a wide selection of modern vehicles to suit your needs.
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <?php 
                // Réinitialiser le pointeur du résultat pour le relire
                $resultat->data_seek(0);
                while ($car = $resultat->fetch_assoc()) { 
                ?>
                    <div class="col-lg-4 col-md-6 mb-2">
