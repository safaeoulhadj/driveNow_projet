                ...
                <form method="GET" action="">
                    <div class="filtre-form">
                        ...
                        <?php if (!empty($status_filter)): ?>
                            <a href="gestion_location.php" class="reset-btn">Réinitialiser</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <?php
                ...
                if ($status == 'acceptée') {
                    echo '<span class="badge bg-success text-white">✅ Acceptée</span>';
                } elseif ($status == 'refusée') {
                    echo '<span class="badge bg-danger text-white">❌ Refusée</span>';
                } elseif ($status == 'en attente') {
                    echo '<span class="badge bg-warning text-dark">⌛ En attente</span>';
                } elseif ($status == 'terminée') {
                    echo '<span class="badge bg-info text-white">✔️ Terminée</span>';
                } else {
                    echo '<span class="badge bg-secondary text-white">' . htmlspecialchars($row['status']) . '</span>';
                }
            ?>
            </td>
            <td>
